...
public class Plexus : MonoBehaviour
{
    ...
    public int amountOfPoints = 250;
    public int PPPS = 1; // Processed Points Per Second
    public float lineWidth = 0.04f;
    public Material lineMaterial;

    public Vector3 box = new Vector3(5, 4, 5);

    public float particleSpeed = 0.72f;
    public float maxConnDistance = 2.0f; // The maximum distance for two points to connect
